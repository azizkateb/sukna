...
export default function Home() {
  ...
  return (
    <>
      ...
      <footer><div className="container footerGrid"><div><a className="brand footerBrand" href="#home">سُكـ<span>نى</span></a><p>وجهتك الموثوقة لاكتشاف إقامات مختارة في أجمل مدن المملكة.</p></div><div><b>استكشف</b><a href="#destinations">الوجهات</a><a href="#listings">العقارات</a><a href="#why">لماذا نحن؟</a></div><div><b>المدن</b><a href="#">الرياض</a><a href="#">جدة</a><a href="#">مكة</a></div><div><b>الدعم</b><a href="#">تواصل معنا</a><a href="#">الأسئلة الشائعة</a><a href="#">سياسة الخصوصية</a></div></div><div className="container copyright"><span>© 2026 سُكنى. جميع الحقوق محفوظة.</span><span>صُمم لإقامات أجمل</span></div></footer>
      <button
        className="Btn"
        type="button"
